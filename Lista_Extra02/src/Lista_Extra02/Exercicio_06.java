...
/*6. Faça um programa que leia um vetor inteiro N[10].
 Imprima em ordem não decrescente os números pares armazenados no vetor e em ordem não crescente os números ímpares.*/
